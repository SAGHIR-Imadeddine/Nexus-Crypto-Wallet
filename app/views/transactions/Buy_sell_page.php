...
<article>
    ...
    <div id="buy" class="mt-4">
        <form action="<?php echo URLROOT; ?>/Transaction/add_transac" method="post" class="w-[70vw]  mx-auto shadow-lg shadow-indigo-500/50 rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="hidden mt-2" id="send">
        <form action="<?php echo URLROOT; ?>/transaction/send_transac" method="post" class=" w-[70vw]  mx-auto shadow-lg shadow-indigo-500/50 rounded px-8 pt-6 pb-8 mb-4">
